...
- Name: admin-console.spec.js >> Module 3: Main Sections (Reorder & Visibility) >> TC3.3 - [Edge Case] Page does not crash when interacting with sections
- Location: e2e\admin-console.spec.js:239:3
