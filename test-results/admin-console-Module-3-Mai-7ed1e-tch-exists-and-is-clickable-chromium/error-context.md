...
- Name: admin-console.spec.js >> Module 3: Main Sections (Reorder & Visibility) >> TC3.2 - Toggle visibility switch exists and is clickable
- Location: e2e\admin-console.spec.js:213:3
...
Call log:
  - waiting for locator('button[class*="rounded-lg"]').filter({ has: locator('svg') }).first()
    - locator resolved to <button class="md:hidden p-2 text-gray-500 hover:text-red-600 bg-gray-100 rounded-lg">…</button>
      ...
      - main [ref=e42]:
        - generic [ref=e43]:
          ...
          - generic [ref=e93]:
            ...
            - generic [ref=e102]:
              - button "หน้าหลัก /" [active] [ref=e103] [cursor=pointer]:
                - img [ref=e104]
                - generic [ref=e107]:
