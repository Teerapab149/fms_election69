...
- Name: admin-console.spec.js >> Admin Page Loading & Navigation >> TC-NAV.4 - Console errors check on admin page
- Location: e2e\admin-console.spec.js:565:3
      ...
      - generic [ref=e12]:
        - generic [ref=e13]:
          ...
          - generic [ref=e19]:
            ...
            - text: "223"
            - generic [ref=e30]: "| case \"toggle\": return <ToggleControls config={config} onChange={handleChange} />; `---- Caused by: Syntax Error"
        - contentinfo [ref=e31]:
