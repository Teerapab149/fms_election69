  ...
  return (
    <div className="gh-stat gh-stat--lime" data-element="stats-eligible-card" data-variant="gumroad">
      ...
      <style jsx global>{`
        ...
        .gh-stat--lime{ background:var(--stat-bg-2, #C2F47E); }
        .gh-stat__foot{ position:relative; z-index:1; display:flex; flex-direction:column; gap:8px; }
        .gh-stat__bar{ height:15px; background:#FFFDFA; border:2.5px solid #26271c; border-radius:999px; overflow:hidden; }
        .gh-stat__bar > span{ display:block; height:100%; min-width:8px; background:#26271c; border-radius:999px 0 0 999px; transition:width .8s cubic-bezier(.2,.8,.2,1); }
      `}</style>
    </div>
  );
}
