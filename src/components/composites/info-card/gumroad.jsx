...
export default function InfoCardGumroad(props) {
  return (
    <>
      ...
      <style jsx global>{`
        .el-infocard{ width:100%; max-width:520px; background:var(--paper, #FFFDFA); border:2.5px solid var(--ink, #26271c); border-radius:26px;
          box-shadow:8px 8px 0 var(--ink, #26271c); padding:44px 36px 40px; text-align:center; }
