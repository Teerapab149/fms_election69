    ...
    <>
      ...
      <style jsx global>{`
        .el-member{ display:flex; flex-direction:column; width:100%; padding:0; font-family:inherit; color:inherit; cursor:pointer;
          background:#FFFDFA; border:2.5px solid #26271c; border-radius:18px; box-shadow:3px 3px 0 #26271c; overflow:hidden; text-align:center;
          transition:transform .15s ease-out, box-shadow .15s ease-out; }
        .el-member:hover{ transform:translate(-2px,-2px); box-shadow:5px 5px 0 #26271c; }
        .el-member__photo{ position:relative; aspect-ratio:1; background:#FFE9D6; display:grid; place-items:center; border-bottom:2px solid #26271c; overflow:hidden;
        ...
        .el-member .el-meta{ display:block; padding:0 8px 12px; font-size:11px; color:#5c5a4b; letter-spacing:.08em; }
        .el-member__photo .el-img--empty{ color:#26271c; }
