...
export const GLOBAL_CONFIG_FIELDS = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "activityHours", label: "ชั่วโมงกิจกรรมที่ได้รับ", type: "number", col: "half", allowEmpty: true, hint: "เลขชั่วโมงที่นักศึกษาได้จากการทำแบบประเมิน · เว้นว่าง = หน้าขอบคุณพูดแค่ “รับชั่วโมงกิจกรรม” ไม่ระบุเลข · ใส่เลขเมื่อคณะยืนยันแล้วเท่านั้น เพราะทุก template จะประกาศเลขนี้ตรงกัน" },
    ],
  },
  {
