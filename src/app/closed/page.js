...
export default function ClosedPage() {
    ...
    const getMessage = () => {
        ...
        // PAUSE ต้องแยกจาก ENDED ให้ขาด — ทั้งสองอย่างทำให้ลงคะแนนไม่ได้เหมือนกัน แต่คนละเรื่อง
        //
        // check-status (route.js:30) แปลง PAUSE เป็น electionStatus "CLOSED" ซึ่งตกมาที่ข้อความ
        // ท้ายสุด "ระบบปิดรับลงคะแนน ... หรือหมดเวลาการลงคะแนนแล้ว" — นักศึกษาที่มาเจอตอนที่
        // เจ้าหน้าที่กด PAUSE ฉุกเฉินกลางวันเลือกตั้ง จะอ่านว่า "หมดเวลาแล้ว" แล้วเลิกพยายาม
        // ทั้งที่อีกสิบนาทีระบบกลับมา นั่นคือคนเสียสิทธิ์เพราะข้อความบนหน้าจอ
        //
        // `systemMode` ส่งมาจาก API อยู่แล้ว (check-status:82) แค่ไม่เคยมีใครอ่าน
        if (systemMode === "PAUSE") {
            return {
                variant: "closed",
                systemMode,
                ...
                desc: (
                    <>
                        ขณะนี้ระบบหยุดให้บริการชั่วคราวเพื่อแก้ไขปัญหา<br />
                        <strong>การลงคะแนนยังไม่สิ้นสุด</strong> กรุณากลับมาอีกครั้งในอีกสักครู่
                    </>
                )
            };
        }
