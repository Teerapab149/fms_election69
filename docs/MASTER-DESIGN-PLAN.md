...
**T4.3 · สื่อประชาสัมพันธ์ของพรรค (โน้ตไว้ 2026-07-28 — owner สั่งจดก่อน ยังไม่ทำ)** — เพิ่มหัวข้อใน
  หน้าต่างแก้ไขพรรคสำหรับ "พรรคนี้โปรโมตตัวเองยังไง": รูป/โปสเตอร์เพิ่มเติม · ลิงก์คลิปวิดีโอ ·
  ช่องทางโซเชียลของพรรค (IG / Facebook / TikTok) แล้วให้หน้าแนะนำพรรคหยิบไปแสดง
  · **ที่ต้องคิดก่อนลงมือ:** เก็บเป็น Json field ใหม่บน `Candidate` (เช่น `media`) จะได้ไม่ต้อง
  migrate ทุกครั้งที่เพิ่มช่องทาง · ลิงก์จากผู้ใช้ = ต้อง validate + `rel="noopener noreferrer"` ·
  embed คลิปจากภายนอกขัดกับ CSP ที่ตั้งไว้ ให้เป็นลิงก์ออกไปก่อน อย่าฝัง iframe ·
  ทุก template ต้องมีที่ทางให้มันโดยไม่พังของเดิม (invariants §3) — เข้าคิวรอบถัดไป ไม่ใช่รอบส่งมอบนี้
