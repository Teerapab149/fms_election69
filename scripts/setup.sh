...
# ── 6.5 สิทธิ์เขียนโฟลเดอร์รูป ──────────────────────────────────────────────
step "6.5 สิทธิ์เขียนรูปที่อัปโหลด"
# docker-compose bind-mount ./public/images จากเครื่องโฮสต์เข้าไปในคอนเทนเนอร์ ส่วนแอป
...
'
  printf '    docker compose -f %s restart web
' "$COMPOSE_FILE"
fi
